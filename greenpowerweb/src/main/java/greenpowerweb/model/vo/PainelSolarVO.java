...
public class PainelSolarVO {
	...
	private int energia_gerada_kwh;
	...
	public int getEnergia_gerada_kwh() {
		return energia_gerada_kwh;
	}

	public void setEnergia_gerada_kwh(int energia_gerada_kwh) {
		this.energia_gerada_kwh = energia_gerada_kwh;
	}

	public int getEnergia_consumida_kwh() {
		return energia_consumida_kwh;
	}

	public void setEnergia_consumida_kwh(int energia_consumida_kwh) {
		this.energia_consumida_kwh = energia_consumida_kwh;
	}
